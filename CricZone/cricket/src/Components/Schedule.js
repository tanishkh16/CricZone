...
import International from './Domestic';
...
const convertToIST = (timestamp) => {
  ...
  return (
    <div className="pt-2 pb-4 " style={backgroundStyle}>
        <div className='flex justify-center mt-2 ' >
        <Navbar/>
        </div>
        <div className='mt-4 ml-60 mr-60 bg-slate-100 mb-20 opacity-90'>
        <div className='flex  '>
        ...
        <div className='flex mt-4'>
            <button className='rounded-xl border mr-10 ml-10 w-32 bg-green-600 opacity-90 text-slate-100 '><Link to='schedule'>International</Link></button>
